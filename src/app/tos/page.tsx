...
export const metadata = {
  title: "Cal AI | Terms of Service",
  description: "Download Today",
};

const HTML = `<h1>Terms and Conditions</h1> <p>Last Updated: November 28, 2025</p> <p>Please read these Terms and Conditions carefully before accessing or using the Cal AI Service.</p> <h2>1. Interpretation and Definitions</h2> <h3>1.1 Interpretation</h3> <p>
...
</li> <li> <strong>Application</strong> means the mobile application titled “Cal AI – Calorie Tracker,” 
...
means Cal AI, Inc., a Delaware corporation, with a mailing address at 
...
</li> <li> <strong>Website</strong> means <a href="https://calai.app" target="_blank" rel="noopener noreferrer">calai.app</a>
...
Your access to and use of the Service is conditioned upon Your acceptance of these Terms and the 
        Cal AI Privacy Policy. By accessing or using the Service, You acknowledge that You have read, 
...
Cal AI does not provide medical advice, nutritional counseling, or professional health services. 
...
</p> <h2>18. Contact Information</h2> <p>If You have questions about these Terms, You may contact Us at:</p> <ul> <li>Email: <a href="mailto:support@calai.app">support@calai.app</a></li> </ul>`;
